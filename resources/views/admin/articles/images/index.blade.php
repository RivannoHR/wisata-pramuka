...
<div class="table-container">
    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 120px;">
                    <div class="operation-cell">
                        ...
                        @if ($images->count() > 1)
                        <form action="{{ route('admin.articles.images.delete', [$article->id ,$image->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="edit-popup-overlay" id="edit-popup-{{ $image->id }}">
                        <div class="edit-popup-content">
                            ...
                            <h4>Edit Image</h4>
                            <form action="{{ route('admin.articles.images.edit', [$article->id, $image->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
            ...
            @empty
            <tr>
                <td colspan="8">No Images Found For {{ $article->title }}</td>
            </tr>
            @endforelse
        </tbody>
    </table>
...
<div class="operation-container">
    ...
    <div class="edit-popup-overlay" id="edit-popup-create">
        <div class="edit-popup-content">
            ...
            <h4>Add New Image</h4>
            <form action="{{ route('admin.articles.images.create', $article->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
