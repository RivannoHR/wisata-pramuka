                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                                        ...
                                        <span style="color: #374151;">{{ $product->visit_count ?? 0 }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        @if($product->is_featured ?? false)
                                            <button type="button" class="btn btn-sm btn-warning" title="Remove from Featured" onclick="toggleFeatured({{ $product->id }}, false)">
                                                <i class="fas fa-star-half-alt"></i>
                                            </button>
                                        @else
                                            <button type="button" class="btn btn-sm btn-info" title="Add to Featured" onclick="toggleFeatured({{ $product->id }}, true)">
