                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-cell">
                            <form method="POST" action="{{ route('admin.tourist-attractions.reviews.delete', $review->id) }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this review?')">
                                @csrf
                                @method('DELETE')
