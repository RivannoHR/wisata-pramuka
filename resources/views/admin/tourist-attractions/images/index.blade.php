...
<div class="page-header">
    <a href="{{ route('admin.tourist-attractions') }}" class="back-button">← Back to Tourist Attractions</a>
    <h2 class="page-title">Images for: {{ $touristAttraction->name }}</h2>
</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="single-button-cell">
                    <form action="{{ route('admin.tourist-attractions.images.toggle.isfeatured', [$touristAttraction->id, $image->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                ...
                <td class="operation-cell-container">
                    <div class="operation-cell">
                        ...
                        @if ($images->count() > 1)
                        <form action="{{ route('admin.tourist-attractions.images.delete', [$touristAttraction->id ,$image->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="edit-popup-overlay" id="edit-popup-{{ $image->id }}">
                        <div class="edit-popup-content">
                            ...
                            <h4>Edit Image</h4>
                            <form action="{{ route('admin.tourist-attractions.images.edit', [$touristAttraction->id, $image->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
            ...
            @empty
            <tr>
                <td colspan="8">No Images Found For {{ $touristAttraction->name }}</td>
            </tr>
            @endforelse
        </tbody>
    </table>
...
<div class="operation-container">
    ...
    <div class="edit-popup-overlay" id="edit-popup-create">
        <div class="edit-popup-content">
            ...
            <h4>Add New Image</h4>
            <form action="{{ route('admin.tourist-attractions.images.create', $touristAttraction->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
