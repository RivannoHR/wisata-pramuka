...
<div class="header-section">
    ...
    <a href="{{ route('admin.accommodations') }}" class="back-link">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="action-cell">
                    <form action="{{ route('admin.accommodations.reviews.delete', $review->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this review?')">
                        @csrf
                        @method('DELETE')
...
<!-- Bulk Delete Form -->
<form id="bulk-delete-form" action="{{ route('admin.accommodations.reviews.bulk-delete', $accommodation->id) }}" method="POST" style="display: none;">
    @csrf
