        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="max-height: 100px; overflow-y: auto;">
                    ...
                    <br>
                    @endforeach
                    <form action="{{ route('admin.accommodations.roomtypes', $accommodation->id) }}" method="GET">
                ...
                <td>
                    <div class="operation-cell">
                        ...
                        <form
                            ...
                            method="POST"
                            onsubmit="return confirm('Are you sure you want to delete {{ $accommodation->name }}? This action cannot be undone.');">
                            @csrf
                            @method('DELETE')
...
<div class="operation-container">
    <form
        ...
        method="POST"
        onsubmit="return confirm('Are you absolutely sure you want to delete all accommodations? This action cannot be undone.');">
        @csrf
        @method('DELETE')
        <button type="submit" class="delete-button">
