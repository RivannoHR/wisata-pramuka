...
<form method="POST" action="{{ route('admin.accommodations.apply', $accommodation) }}" class="create-product-form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="number" name="price" id="price" value="{{ $accommodation->price }}" step="0.01" min="0">
        @error('price')
        <span class="error-message">{{ $message }}</span>
        @enderror
    </div>
...
<form method="POST" action="{{ route('admin.accommodations.store') }}" class="create-product-form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="number" name="price" placeholder="Price per Night" value="{{ old('price') }}" step="0.01" required>
        @if ($errors->has('price'))
