...
<div class="attraction-detail-container">
    ...
    <div class="attraction-header">
        <div class="attraction-image-main" style="background-image: url('{{ $article->first_image ? asset('storage/' . $article->first_image) : asset('images/default-article.jpg') }}')">
            <div class="attraction-overlay">
                <h1 class="attraction-title">{{ $article->capital_title }}</h1>
    ...
    <div class="attraction-content">
        ...
        <div class="content-section">
            ...
            <p class="description-text">{{ $article->content }}</p>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="image-gallery">
                <div class="gallery-main-image" id="mainImage"
                    style="background-image: url('{{ $article->first_image ? asset('storage/' . $article->first_image) : asset('images/default-article.jpg') }}')"
                ...
                <div class="gallery-counter">
                    <span id="imageCounter">1</span> of {{ $article->images->count() }} photos
                </div>
            </div>
        </div>
        @endif
                ...
                <div class="comment-item">
                    <div class="comment-header">
                        ...
                        <div class="comment-actions">
                            <form method="POST" action="{{ route('articles.comments.destroy', $comment) }}" style="display: inline;">
                                @csrf
                                @method('DELETE')
...
<script>
    const images = @json($article->images->map(function($image) {
