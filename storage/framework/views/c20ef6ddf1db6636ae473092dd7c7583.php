...
<div class="filter-container">
    <form method="GET" action="<?php echo e(route('admin.products')); ?>" class="filter-form" id="filterForm">
        <input type="hidden" name="filter_yes" value="1">
        <div class="filter-group">
            <input type="text" name="search" placeholder="Search products..." value="<?php echo e(request('search')); ?>" class="search-input">
        </div>
        ...
        <div class="filter-group">
            <select name="sort_by" class="filter-select">
                ...
                <option value="stock_asc" <?php echo e(request('sort_by') == 'stock_asc' ? 'selected' : ''); ?>>Stock (Low to High)</option>
                <option value="stock_desc" <?php echo e(request('sort_by') == 'stock_desc' ? 'selected' : ''); ?>>Stock (High to Low)</option>
            </select>
        </div>

        <div class="filter-group">
            <input type="number" name="min_price" placeholder="Min Price" value="<?php echo e(request('min_price')); ?>" class="price-input">
        </div>
        <div class="filter-group">
            <input type="number" name="max_price" placeholder="Max Price" value="<?php echo e(request('max_price')); ?>" class="price-input">
        </div>
        ...
        <div class="filter-group">
            <select name="stock_filter" class="filter-select">
                ...
                <option value="low_stock" <?php echo e(request('stock_filter') == 'low_stock' ? 'selected' : ''); ?>>Low Stock (≤5)</option>
...
<div class="table-container">
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td class="id-cell"><?php echo e($product->id); ?></td>
                ...
                <td class="price-cell">Rp<?php echo e(number_format($product->price, 0, ',', '.')); ?></td>
                <td class="stock-cell"><?php echo e($product->stock); ?></td>
                <td class="single-button-cell">
                    <form action="<?php echo e(route('admin.products.toggle.isactive', $product->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <button class="status-btn <?php echo e($product->is_active ? 'active-btn' : 'inactive-btn'); ?>"
                            type="submit" title="click to change">
                            <?php echo e($product->is_active ? 'Yes' : 'No'); ?>
                ...
                <td class="single-button-cell">
                    <form action="<?php echo e(route('admin.products.toggle.isfeatured', $product->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <button class="status-btn <?php echo e($product->is_featured ? 'active-btn' : 'inactive-btn'); ?>"
                            type="submit" title="click to change">
                ...
                <td class="image-cell">
                    <img
                        ...
                        class="small-image"
                        data-large-image="<?php echo e(asset('storage/' . $product->image_path)); ?>">
                </td>
                <td>
                    <div class="operation-cell">
                        <form action="<?php echo e(route('admin.products.edit', $product->id)); ?>" method="GET">
...
<div class="operation-container">
    <form
        action="<?php echo e(route('admin.products.delete.all')); ?>"
        method="POST"
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/nathanaelss/Downloads/wisata-pramuka-minimal/resources/views/admin/products/index.blade.php ENDPATH**/ ?>