...
<div class="filter-container">
    <form method="GET" action="<?php echo e(route('admin.articles')); ?>" class="filter-form" id="filterForm">
        <input type="hidden" name="filter_yes" value="1">
        <div class="filter-group">
            <input type="text" name="search" placeholder="Search articles, categories.." value="<?php echo e(request('search')); ?>" class="search-input">
        </div>

        <div class="filter-group">
            <select name="order" class="filter-select">
                <option value="">Sort by</option>
                <option value="asc" <?php echo e(request('order') == 'asc' ? 'selected' : ''); ?>>Date (Ascending)</option>
                <option value="desc" <?php echo e(request('order') == 'desc' ? 'selected' : ''); ?>>Date (Descending)</option>
            </select>
        </div>
...
<div class="table-container">
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td class="id-cell"><?php echo e($article->id); ?></td>
                <td class="name-cell"><?php echo e($article->title); ?></td>
                ...
                <td class="category-cell"><?php echo e($article->category); ?></td>
                <td class="date-cell"><?php echo e($article->formatted_date); ?></td>
                <td class="count-cell">
                    <?php if($article->first_image): ?>
                        <img
                            src="<?php echo e(asset('storage/' . $article->first_image)); ?>"
                            alt="<?php echo e($article->title); ?>"
                            class="small-image"
                            data-large-image="<?php echo e(asset('storage/' . $article->first_image)); ?>"
                ...
                <td class="actions-cell">
                    <a href="<?php echo e(route('admin.articles.edit', $article->id)); ?>" class="edit-link">Edit</a>
                    <a href="<?php echo e(route('admin.articles.images', $article->id)); ?>" class="view-link">Images</a>
                    <a href="<?php echo e(route('admin.articles.comments', $article->id)); ?>" class="edit-link" style="margin-left: 8px;">Comments</a>
                    <form action="<?php echo e(route('admin.articles.delete', $article->id)); ?>" method="POST" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete this article? This action cannot be undone.');">
                        <?php echo csrf_field(); ?>
...
<div class="operation-container">
    <form
        action="<?php echo e(route('admin.articles.delete.all')); ?>"
        method="POST"
    ...
    <form action="<?php echo e(route('admin.articles.create')); ?>" method="GET">
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/nathanaelss/Downloads/wisata-pramuka-minimal/resources/views/admin/articles/index.blade.php ENDPATH**/ ?>