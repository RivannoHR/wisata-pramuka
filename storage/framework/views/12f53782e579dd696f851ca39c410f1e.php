...
<div class="table-container">
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td class="id-cell"> <?php echo e($image->sort_order); ?> </td>
                <td class="image-cell">
                    <img
                ...
                <td class="single-button-cell">
                    <form action="<?php echo e(route('admin.tourist-attractions.images.toggle.isfeatured', [$touristAttraction->id, $image->id])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <td style="width: 120px;">
                    <div class="operation-cell">
                        ...
                        <form action="<?php echo e(route('admin.tourist-attractions.images.delete', [$touristAttraction->id ,$image->id])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="edit-popup-overlay" id="edit-popup-<?php echo e($image->id); ?>">
                        <div class="edit-popup-content">
                            <span class="close-popup" onclick="hideEditPopup('edit-popup-<?php echo e($image->id); ?>')">&times;</span>
                            <h4>Edit Image</h4>
                            <form action="<?php echo e(route('admin.tourist-attractions.images.edit', [$touristAttraction->id, $image->id])); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($errors->any() && $errors->has('product_image')): ?>
                    <script>
                        document.addEventListener('DOMContentLoaded', (event) => {
                            ...
                            const popupId = 'edit-popup-<?php echo e($image->id); ?>';
            ...
            <tr>
                <td colspan="8">No Images Found For <?php echo e($touristAttraction->name); ?></td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
<div class="operation-container">
    ...
    <div class="edit-popup-overlay" id="edit-popup-create">
        <div class="edit-popup-content">
            ...
            <h4>Add New Image</h4>
            <form action="<?php echo e(route('admin.tourist-attractions.images.create', $touristAttraction->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/nathanaelss/Downloads/wisata-pramuka-minimal/resources/views/admin/tourist-attractions/images/index.blade.php ENDPATH**/ ?>