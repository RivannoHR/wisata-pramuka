<?php $__env->startSection('title', 'Products - Pulau Pramuka'); ?>
...
<style>
    ...
    <section class="products-page-section">
        <div class="products-header">
            ...
            <div class="filter-container">
                <form method="GET" action="<?php echo e(route('products.index')); ?>" class="filter-form" id="filterForm">
        ...
        <div class="products-grid" id="productsGrid">
            <?php if($products->count() > 0): ?>
                <?php echo $__env->make('products.partials.product-cards', ['products' => $products], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php else: ?>
    ...
    <script>
        ...
        let hasMorePages = <?php echo e($products->hasMorePages() ? 'true' : 'false'); ?>;
        let loading = false;
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/nathanaelss/Downloads/wisata-pramuka-minimal/resources/views/products/index.blade.php ENDPATH**/ ?>