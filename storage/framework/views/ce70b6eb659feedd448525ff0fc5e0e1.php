                ...
                <div class="mission-images">
                    <div class="images-grid">
                        <div class="mission-image">
                            <img src="<?php echo e(asset('images/about-1.png')); ?>" alt="Rumah Literasi Hijau Activity 1" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                        ...
                        <div class="mission-image">
                            <img src="<?php echo e(asset('images/about-2.png')); ?>" alt="Rumah Literasi Hijau Activity 2" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="image-placeholder" style="display: none;">
                                <i class="fas fa-image"></i>
                                <span>Image 2</span>
                            </div>
                        ...
                        <div class="mission-image">
                            <img src="<?php echo e(asset('images/about-3.png')); ?>" alt="Rumah Literasi Hijau Activity 3" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="image-placeholder" style="display: none;">
                                <i class="fas fa-image"></i>
                                <span>Image 3</span>
                            </div>
                        ...
                        <div class="mission-image">
                            <img src="<?php echo e(asset('images/about-4.png')); ?>" alt="Rumah Literasi Hijau Activity 4" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                            <div class="image-placeholder" style="display: none;">
                                <i class="fas fa-image"></i>
                                <span>Image 4</span>
                            </div>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/nathanaelss/Downloads/wisata-pramuka-minimal/resources/views/about/index.blade.php ENDPATH**/ ?>